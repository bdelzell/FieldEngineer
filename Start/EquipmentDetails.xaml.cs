...
namespace FieldEngineer
{
    ...
    /// </summary>
    public sealed partial class EquipmentDetails : Page
    {
        ...
        {
            // Assign the various bindable items to DefaultViewModel
            var selectedEquipment = await EquipmentDataSource.GetDetailsAsync_Dummy(e.NavigationParameter.ToString());
