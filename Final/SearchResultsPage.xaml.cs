...
namespace FieldEngineer
{
    ...
    public sealed partial class SearchResultsPage : Page
    {
        ...
        private List<Job> _searchResults;
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            if (countOnSite > 0) filterList.Add(new Filter("On Site", countOnSite, false));
            if (countNotStarted > 0) filterList.Add(new Filter("Not Started", countNotStarted, false));
            if (countCompleted > 0) filterList.Add(new Filter("Completed", countCompleted, false));
